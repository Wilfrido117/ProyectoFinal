...
switch ($_GET["op"]){
	...
	case 'guardaryeditar':
        ...
        {  
            ...
            move_upload_file($_FILES["imagen"]["tmp_name"],"../files/articulos".$imagen);
        }
        }
		if (empty($idarticulo)){
	...
	case 'listar':
        ...
        while($reg=$rspta->fetch_object()){
            ...
            $data[]=array(         
                   ...
                   ' <button class="btn btn-success" onclick="activar('.$reg->idarticulo.')"><i class="fa fa-power-off"></i></button>',
                    "1" =>$reg->nombre,
                    "2" =>$reg->categoria,
                    "3" =>$reg->codigo,
                    "4" =>$reg->stock,
